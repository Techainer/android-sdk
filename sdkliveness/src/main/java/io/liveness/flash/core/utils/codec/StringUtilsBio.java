...
public class StringUtilsBio {
    ...
    public static boolean equals(final CharSequence cs1, final CharSequence cs2) {
        ...
        return cs1.length() == cs2.length() && CharSequenceUtilsBio.regionMatches(cs1, false, 0, cs2, 0, cs1.length());
    }
    ...
    public static byte[] getBytesUnchecked(final String string, final String charsetName) {
        ...
        try {
            ...
            throw StringUtilsBio.newIllegalStateException(charsetName, e);
        }
    }
