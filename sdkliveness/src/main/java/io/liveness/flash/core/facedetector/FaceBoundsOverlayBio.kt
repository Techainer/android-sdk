 ...
 */
internal class FaceBoundsOverlayBio @JvmOverloads constructor(ctx: Context, attrs: AttributeSet? = null) :
    View(ctx, attrs) {

    private val facesBounds = mutableListOf<FaceBoundsBio>()
    ...
    internal fun updateFaces(bounds: List<FaceBoundsBio>?) {
