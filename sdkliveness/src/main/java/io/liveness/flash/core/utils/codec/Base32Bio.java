 ...
 * @since 1.5
 */
public class Base32Bio extends BaseNCodecBio {

    /**
     * Builds {@link Base32Bio} instances.
     *
     * @since 1.17.0
     */
    public static class Builder extends AbstractBuilder<Base32Bio, Builder> {
        ...
        @Override
        public Base32Bio get() {
            return new Base32Bio(getLineLength(), getLineSeparator(), getEncodeTable(), getPadding(), getDecodingPolicy());
        }
     ...
     */
    public Base32Bio(final boolean useHex) {
     ...
     */
    public Base32Bio(final boolean useHex, final byte padding) {
     ...
     */
    public Base32Bio(final byte pad) {
        this(false, pad);
    }
     ...
     */
    public Base32Bio(final int lineLength) {
     ...
     */
    public Base32Bio(final int lineLength, final byte[] lineSeparator) {
     ...
     */
    public Base32Bio(final int lineLength, final byte[] lineSeparator, final boolean useHex) {
     ...
     * @throws IllegalArgumentException Thrown when the {@code lineSeparator} contains Base32 characters. Or the lineLength &gt; 0 and lineSeparator is null.
     */
    public Base32Bio(final int lineLength, final byte[] lineSeparator, final boolean useHex, final byte padding) {
     ...
     * @since 1.15
     */
    public Base32Bio(final int lineLength, final byte[] lineSeparator, final boolean useHex, final byte padding, final CodecPolicy decodingPolicy) {
     ...
     * @throws IllegalArgumentException Thrown when the {@code lineSeparator} contains Base32 characters. Or the lineLength &gt; 0 and lineSeparator is null.
     */
    private Base32Bio(final int lineLength, final byte[] lineSeparator, final byte[] encodeTable, final byte padding, final CodecPolicy decodingPolicy) {
        ...
        if (lineLength > 0) {
            ...
            if (containsAlphabetOrPad(lineSeparatorCopy)) {
                final String sep = StringUtilsBio.newStringUtf8(lineSeparatorCopy);
     ...
     * </p>
     * <p>
     * Output is written to {@link Context#buffer Context#buffer} as 8-bit octets, using
     * {@link Context#pos Context#pos} as the buffer position
     * </p>
     *
