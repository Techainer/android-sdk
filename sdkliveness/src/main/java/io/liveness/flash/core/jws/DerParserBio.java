...
class DerParserBio {
	 ...
	 */
	public DerParserBio(InputStream in) throws IOException {
		this.in = in;
	}
	 ...
	 * @throws IOException
	 */
	public DerParserBio(byte[] bytes) throws IOException {
	 ...
	 * @throws IOException
	 */
	public Asn1ObjectBio read() throws IOException {
		int tag = in.read();
		...
		Asn1ObjectBio o = new Asn1ObjectBio(tag, length, value);
