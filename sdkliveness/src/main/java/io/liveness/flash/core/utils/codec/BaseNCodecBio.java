 ...
 * </p>
 */
public abstract class BaseNCodecBio implements BinaryEncoder, BinaryDecoder {
     ...
     */
    protected BaseNCodecBio(final int unencodedBlockSize, final int encodedBlockSize, final int lineLength, final int chunkSeparatorLength) {
     ...
     */
    protected BaseNCodecBio(final int unencodedBlockSize, final int encodedBlockSize, final int lineLength, final int chunkSeparatorLength, final byte pad) {
    ...
    public byte[] decode(final byte[] pArray) {
        if (BinaryCodecBio.isEmpty(pArray)) {
            return pArray;
        }
    ...
    public byte[] decode(final String pArray) {
        return decode(StringUtilsBio.getBytesUtf8(pArray));
    }
    ...
    */
    public String encodeAsString(final byte[] pArray) {
        return StringUtilsBio.newStringUtf8(encode(pArray));
    }
    ...
    public boolean isInAlphabet(final String basen) {
        return isInAlphabet(StringUtilsBio.getBytesUtf8(basen), true);
    }
